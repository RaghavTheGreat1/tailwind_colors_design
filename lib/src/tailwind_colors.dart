...
/// TailwindColors implements Tailwind CSS's color system for Flutter applications.
///
/// This class provides a comprehensive set of color palettes inspired by Tailwind CSS,
/// offering consistent and accessible colors for Flutter applications. Each color palette
/// includes 11 different shades (from 50 to 950), allowing for flexible and systematic
/// color usage across your application.
///
/// Example usage:
/// ```dart
/// // Using a specific shade of a color
/// Container(
///   color: TailwindColors.blue[500],
///   child: Text('Blue background'),
/// )
///
/// // Using the default shade (500)
/// Container(
///   color: TailwindColors.blue,
///   child: Text('Default blue background'),
/// )
/// ```
///
...
/// - Pinks: pink, rose
///
/// Each color palette follows Tailwind CSS's systematic approach to color,
/// with shades ranging from 50 (lightest) to 950 (darkest):
/// - 50: Lightest shade, perfect for backgrounds
/// - 100-300: Light shades, good for subtle backgrounds and borders
/// - 400-600: Medium shades, ideal for primary UI elements
/// - 700-950: Dark shades, excellent for text and emphasis
///
/// You can also create custom color palettes using [createCustomColor]:
/// ```dart
...
class TailwindColors {
  static const TailwindColor slate = TailwindColor(0xFF64748B, {
    50: Color(0xFFF8FAFC),
  ...
  static const TailwindColor gray = TailwindColor(0xFF6B7280, {
    50: Color(0xFFF9FAFB),
  ...
  static const TailwindColor zinc = TailwindColor(0xFF71717A, {
    50: Color(0xFFFAFAFA),
  ...
  static const TailwindColor neutral = TailwindColor(0xFF737373, {
    50: Color(0xFFFAFAFA),
  ...
  static const TailwindColor stone = TailwindColor(0xFF78716C, {
    50: Color(0xFFFAFAF9),
  ...
  static const TailwindColor red = TailwindColor(0xFFEF4444, {
    50: Color(0xFFFEF2F2),
  ...
  static const TailwindColor orange = TailwindColor(0xFFF97316, {
    50: Color(0xFFFFF7ED),
  ...
  static const TailwindColor amber = TailwindColor(0xFFF59E0B, {
    50: Color(0xFFFFFBEB),
  ...
  static const TailwindColor yellow = TailwindColor(0xFFEAB308, {
    50: Color(0xFFFEFCE8),
  ...
  static const TailwindColor lime = TailwindColor(0xFF84CC16, {
    50: Color(0xFFF7FEE7),
  ...
  static const TailwindColor green = TailwindColor(0xFF22C55E, {
    50: Color(0xFFF0FDF4),
  ...
  static const TailwindColor emerald = TailwindColor(0xFF10B981, {
    50: Color(0xFFECFDF5),
  ...
  static const TailwindColor teal = TailwindColor(0xFF14B8A6, {
    50: Color(0xFFF0FDFA),
  ...
  static const TailwindColor cyan = TailwindColor(0xFF06B6D4, {
    50: Color(0xFFECFEFF),
  ...
  static const TailwindColor sky = TailwindColor(0xFF0EA5E9, {
    50: Color(0xFFF0F9FF),
  ...
  static const TailwindColor blue = TailwindColor(0xFF3B82F6, {
    50: Color(0xFFEFF6FF),
    100: Color(0xFFDBEAFE),
  ...
  static const TailwindColor indigo = TailwindColor(0xFF6366F1, {
    50: Color(0xFFEEF2FF),
  ...
  static const TailwindColor violet = TailwindColor(0xFF8B5CF6, {
    50: Color(0xFFF5F3FF),
  ...
  static const TailwindColor purple = TailwindColor(0xFFA855F7, {
    50: Color(0xFFFAF5FF),
  ...
  static const TailwindColor fuchsia = TailwindColor(0xFFD946EF, {
    50: Color(0xFFFDF4FF),
  ...
  static const TailwindColor pink = TailwindColor(0xFFEC4899, {
    50: Color(0xFFFDF2F8),
  ...
  static const TailwindColor rose = TailwindColor(0xFFF43F5E, {
    50: Color(0xFFFFF1F2),
  ...
  /// Creates a custom color palette following the Tailwind CSS color system.
  ///
  /// Use this method to create your own color palettes that follow the same
  /// structure as the built-in Tailwind colors.
  ///
  /// Parameters:
  /// - [primary]: The primary color value (typically the 500 shade) as an integer
  /// - [shades]: A map of shade values (50-950) to their corresponding [Color] objects
  ///
  /// Example:
  /// ```dart
  /// final customColor = TailwindColors.createCustomColor(
  ///   0xFF6366F1,
  ///   {
  ///     50: Color(0xFFF8FAFC),
  ///     100: Color(0xFFF1F5F9),
  ...
  /// ```
  ///
  /// For best results, follow Tailwind CSS's color guidelines:
  /// - 50: Very light, almost white
  /// - 100-300: Light shades
  /// - 400-600: Medium shades (500 is typically the base color)
  /// - 700-950: Dark shades
  static TailwindColor createCustomColor(int primary, Map<int, Color> shades) {
    return TailwindColor(primary, shades);
  }
}
